  ...
  return (
    <div className='max-w-lg mx-auto p-3 w-full'>
        ...
        <form className='flex flex-col gap-4'>
            ...
            <img src={imageFileUrl || currentUser.profilePicture} alt='user' className={`rounded-full w-full h-full border-8 border-[lightgrey] object-cover ${imageFileUploadingProgress && imageFileUploadingProgress < 100 && "opacity-60"}` }/>
            ...
            <TextInput type='email' id="username" placeholder='email'defaultValue={currentUser.email}></TextInput>
            <TextInput type='password' id="username" placeholder='password'></TextInput>
