...
const handleSubmit = async(e)=>{
    ...
    try{
     ...
     const res = await authFetch.put(`/user/update/${currentUser._id}`,formData)
...
try{
    ...
    const res = await authFetch.delete(`/user/delete/${currentUser._id}`)
    if(!res){
