...
export default function DashboardComp() {
    ...
    useEffect(()=>{
        ...
        const fetchUsers = async()=>{
            try {
                const res = await authFetch.get('/user/getusers?limit=5')
        ...
        const fetchPosts = async()=>{
            try {
                const res = await authFetch.get('/post/getPosts?limit=5')
                if(res.data.status == "success"){
        ...
        const fetchComments = async()=>{
            try {
                const res = await authFetch.get('/comment/getComments?limit=5')
                if(res.data.status == "success"){
        ...
        <div className="flex flex-wrap gap-4 py-3 mx-auto justify-center">
            <div className="flex flex-col w-full md:w-auto shadow-md p-2 rounded-md dark:bg-gray-800">
                <div className="flex justify-between p-3 text-sm font-semibold">
                    ...
                    ><Link to={"/dashboard?tap=users"}>See all</Link></Button>
                </div>
                <Table hoverable>
                    <Table.Head>
            ...
            <div className="flex flex-col w-full md:w-auto shadow-md p-2 rounded-md dark:bg-gray-800">
                <div className="flex justify-between p-3 text-sm font-semibold">
                    ...
                    outline
                    gradientDuoTone='purpleToPink'
                    ><Link to={"/dashboard?tap=comments"}>See all</Link></Button>
                </div>
                <Table hoverable>
                    <Table.Head>
